...
const headlineData: HeadlineDataType = require('../../utils/headlineData.json');
          ...
          <div className='container-fluid'>
            <div className='row'>
              ...
              <div className='col-4'>
                <img
                  loading='eager'
                  src='https://aav-myawsbucket.s3.us-west-2.amazonaws.com/portfolio/images/AV_Logo_Light.svg'
                  alt='AV logo'
                  width='140'
                  height='140'
